...
public class RegisterController {
	...
	public void validatePassword(FacesContext context, UIComponent component,
		...
		{
			throw new ValidatorException(new FacesMessage("Le mot de passe n'est pas valide (plus de 6 et moins de 32 lettres, " +
	...
	public void validateLastName(FacesContext context, UIComponent component,
		...
		{
			throw new ValidatorException(new FacesMessage("Le nom de famille entré n'est pas valide"));
		}
	...
	public void validateFirstName(FacesContext context, UIComponent component,
		...
		{
			throw new ValidatorException(new FacesMessage("Le prénom entré n'est pas valide"));
		}
		
	}
	/** Le pseudo est valide => plus de deux caractères + commence par une lettre + composé que de lettres
	 * et de chiffres +  pas déjà réservé */
	public void validateNickname(FacesContext context, UIComponent component,
		...
		{
			throw new ValidatorException(new FacesMessage("Le pseudonyme entré est invalide"));
		}
		
		if(userManager.searchUserByNickname(nname)!= null)
		{
			throw new ValidatorException(new FacesMessage("Le pseudonyme est déjà utilisé"));
		}
	}
	...
	public void validateEmail(FacesContext context, UIComponent component,
		...
		{
			throw new ValidatorException(new FacesMessage("L'adresse e-mail entrée est caca"));
		}
	}
